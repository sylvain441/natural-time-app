...
#### Af hverju er núverandi tímakerfi okkar gervið?
...
#### Hvernig hefur tímaskynjun áhrif á vellíðan?
...
#### Hver bjó til hugmyndina um Náttúrulegan tíma?
...
#### Hvernig get ég lagt mitt af mörkum við þetta verkefni?
...
- Kannaðu frumkóðann á GitHub og leggðu til úrbætur
- Búðu til þitt eigið náttúrulega úr og deildu hönnuninni
- Samþættaðu náttúrulegan tíma í daglegt líf þitt og fylgstu með breytingunum
- Talaðu um hugmyndina við aðra og skipulagðu fundi byggða á náttúrulegum tíma
- Ímyndaðu þér ný forrit eða notkun náttúrulegs tíma á mismunandi sviðum
...
- Þegar vísirinn er efst (180°), er hádegi, sólin er á hápunkti sínum
- Þegar hann er neðst (0°), er miðnætti
- Vísirinn gerir einn fullan hring á dag, snýst jafn hægt og sólin á himni
...
#### Hverjir eru kostir þess að nota það daglega?
...
- Án úrs geturðu einfaldlega horft á sólina - heilinn gerir þýðinguna náttúrulega
- Þegar sólin er ekki sýnileg gefur úrið þessar dýrmætu upplýsingar

Þessi samstilling er sérstaklega verðmæt fyrir lífsstíla sem tengjast náttúrunni og náttúrulegum hringrásum.

#### Af hverju að skipta tímanum í 360° í stað 24klst/60mín/60sek?
...
- Þessi samþykkt er almennt kennd í rúmfræði og krefst engrar viðbótarnáms
- Flestir geta auðveldlega ímyndað sér 90° horn (fjórðungur dags) eða 180° horn (hálfur dagur)
...
#### Hvað tákna kamparnir í miðju skífunnar?
...
- Neðri kampur: staðsetning vísisins við sólarupprás á sumri (lengsti dagur)
- Efri kampur: staðsetning vísisins við sólarupprás á vetri (stysti dagur)

**Hægri hlið (sólsetur):**
- Efri kampur: staðsetning vísisins við sólsetur á vetri (stysti dagur)
- Neðri kampur: staðsetning vísisins við sólsetur á sumri (lengsti dagur)
...
#### Af hverju er náttúrulegi tíminn háður lengdargráðu?
...
1. **Jörðin er skipt í 360 lengdarbaugum** (ímyndaðar línur sem liggja frá Norðurpólnum til Suðurpólsins)
2. **Sólin fer yfir þessa 360 lengdarbaugum á einum degi**
3. **Þegar vísirinn hreyfist eina gráðu á náttúrulega úrinu**, þýðir það að sólin hefur ferðast eina gráðu í kringum jörðina
...
#### Hvernig skrifar maður dagsetningu í náttúrulegum tíma?
...
- Ár 10 (2022-2023 í gregoríska dagatalinu)
- 5. tungl
- 22. dagur þess tungls
- Sólin er í 202,63 gráðum á himni
- Við lengdargráðu 5,2 gráður austur
...
#### Hvernig reiknar maður tímamismun og skilur NT+/- táknsetninguna?
...
- NT+030 þýðir "Náttúrulegur tími við 30° austur" (eins og í Istanbúl)
- NT-075 þýðir "Náttúrulegur tími við 75° vestur" (eins og í New York)
- NTZ samsvarar náttúrulegum tíma við Greenwich lengdarbauginn
...
#### Hvað gerist við sumar- og vetrartímaskipti?
...
#### Hvernig breytir maður hefðbundnum klukkustundum í gráður?
...
#### Af hverju segjum við ekki lengur "hvað er klukkan?"
...
#### Er hægt að búa til eigið náttúrulegt úr?
...
1. Finna slíkt kerfi
2. Nota aðeins klukkustundavísinn (ekki mínútu- og sekúnduvísa)
3. Festa það við úr eða skipta út kerfinu í núverandi úri
4. Breyta skífunni og grafa kampana sem samsvara notkunarstað
...
#### Hvernig meðhöndlar náttúrulegi tíminn breytileika í snúningi jarðar?
...
- Sólarupprás og sólsetur eru reiknuð út frá raunverulegum, nákvæmum athugunum á sól á tilteknum stað
- Sólhádegi (180°) er ákvarðað samkvæmt meðaltíma (UTC), sem jafnar náttúrulegar breytingar á snúningi jarðar yfir heilt ár.
...
#### Eru 13 tungl samstillt við raunverulega tunglfösa?
...
#### Hverjir eru kostir þess að nota 13 tungl í daglegu lífi?

Helsti kosturinn er að lifa í samræmdum hringrásum sem eru auðskiljanlegir fyrir heila okkar.

Í þessu kerfi:
- Hvert tungl byrjar alltaf á fyrsta degi vikunnar
- Hvert tungl inniheldur nákvæmlega 4 vikur
- 14. dagurinn (til dæmis) er alltaf síðasti dagur annarrar vikunnar, óháð öld eða árþúsundi
- Árið byrjar alltaf á fyrsta degi vikunnar í fyrsta tungli
...
#### Hvað tákna 7 litirnir í vikudögunum?
...
#### Af hverju að nota hugtakið "Spírall" frekar en "Dagatal"?
...
#### Hvað er svo slæmt við gregoríska dagatalið?
...
- Það gerir útreikning á tíma milli mismunandi dagsetninga erfiðan
- Það leyfir ekki auðveld spá um hvaða vikudag muni samsvara framtíðardagsetningu
- Mismunandi lengd mánaða flækir skipulagningu (til dæmis borgar þú sömu leigu í febrúar og í janúar, þrátt fyrir 2-3 daga mismun)
- Saga þess felur í sér frávik eins og hvarf 10 daga við upptöku þess (á mismunandi dagsetningum eftir löndum)
- Regla þess fyrir hlaupár er flókin (á 4 ára fresti, nema á 100 ára fresti, en ekki á 400 ára fresti)
...
#### Hvenær byrjar náttúrulega árið?
...
#### Af hverju samsvarar ár 001 árinu 2012?
...
Þetta forrit var búið til ([naturaltime.app](https://naturaltime.app)) til að skilja og leika sér með náttúrulega tímaúrið. Það er hýst á [github](https://github.com/sylvain441/natural-time-app) og gefið út undir Creative Commons Zero leyfinu.

Frumkóði náttúrulegs tíma er skipt í þrjá hluta:

- Fullkomnar forskriftir náttúrulegs tíma (á ensku): [github.com/sylvain441/natural-time](https://github.com/sylvain441/natural-time)
- JavaScript bókasafn til að reikna náttúrulegan tíma: [github.com/sylvain441/natural-time-js](https://github.com/sylvain441/natural-time-js)
- VueJs forrit fyrir náttúrulega tímaúrið: [github.com/sylvain441/natural-time-app](https://github.com/sylvain441/natural-time-app) — [naturaltime.app](https://naturaltime.app)
...
#### Hvernig set ég upp forritið í ótengdum ham?

Þetta er ekki í raun forrit... heldur frekar vefsíða sem getur virkað án nettengingar. Svo ekki leita að henni í App Store eða Play Store, farðu einfaldlega á [naturaltime.app](https://naturaltime.app) og smelltu svo á:

- iOS Safari: *Deila > Bæta á heimaskjá*
- Android Chrome: *Valmynd > Bæta á heimaskjá*
- Google Chrome: *Veffangastika > Setja upp Natural Time*
- Microsoft Edge: *Veffangastika > Setja upp Natural Time*
- Firefox: *Ótengt uppsetning ekki leyfð*
- Safari Mac: *Ótengt uppsetning ekki leyfð*

#### Af hverju biður forritið um landfræðilega staðsetningu?
...
#### Hvernig er gögnum notenda stjórnað og verndað?
...
Miklar þakkir til fjallanna, geitanna, llama og mauranna fyrir innblástur þeirra.  
Óendanleg þakklæti til Toto og Uncle Skywalker, tveggja tímakönnuða. Takk fyrir að vera til.

Þakkir til Don Cross, höfundar [astronomy engine](https://github.com/cosinekitty/astronomy/) sem gerir forritinu kleift að reikna hreyfingu himintungla á himni. Einnig þakkir til alls heimsins opins hugbúnaðar sem býður heiminum þroskaðar lausnir og auðlindir eins og Vue3, Vite, OpenLayers, OpenStreetMap, ... sem notaðar voru til að búa til þetta forrit.

Náttúrulegi tíminn fæddist í frönskum Ölpunum vor/sumar 2022.  
Fyrir allar spurningar: [sylvain441@pm.me](mailto:sylvain441@pm.me) – [@sylvain441](https://t.me/sylvain441) (Telegram).
