    ...
    <div class="max-w-6xl mx-auto">
      ...
      <section class="w-full flex flex-col items-center justify-center px-4 md:py-2 md:p-6 text-slate-800 dark:text-slate-100">
        <h1 class="w-full text-center text-3xl md:text-6xl font-bold pt-3 pb-4 md:pt-28 md:pb-10">
          <strong class="font-title underline decoration-nt-yellow-light transition-all duration-300 hover:decoration-4">{{ $t('welcome.title') }}</strong>
          <br>
          <small class="text-xs md:text-2xl uppercase font-bold md:mt-3 block opacity-90">{{ $t('welcome.subtitle') }}</small>
        </h1>
      </section>
          ...
          <div class="max-w-5xl mx-auto px-2 md:px-0 py-8 md:py-16">
            <div class="flex flex-col md:flex-row items-center justify-end md:gap-6 lg:gap-12 relative">
              <div class="w-full md:w-2/3 lg:w-[55%] flex flex-col justify-center px-4 md:px-8 pb-6 md:pb-0 z-10 md:order-2">
                <h2 class="text-3xl md:text-5xl mb-4 font-title dark:text-nt-yellow-light/90">{{ $t('welcome.naturalClock.title') }}</h2>
                <p class="mb-6 text-black dark:text-slate-100 md:text-lg whitespace-pre-line">
          ...
          <div class="max-w-5xl mx-auto px-2 md:px-0 py-8 md:py-16">
            <div class="flex flex-col md:flex-row items-center justify-start md:gap-6 lg:gap-12 relative">
              <div class="w-full md:w-2/3 lg:w-[55%] flex flex-col justify-center px-6 md:px-8 pb-6 md:pb-0 z-10">
                <h2 class="text-3xl md:text-5xl mb-4 font-title dark:text-nt-cyan-light/90 md:text-right">{{ $t('welcome.thirteenMoons.title') }}</h2>
                <p class="mb-6 text-black dark:text-slate-100 md:text-lg md:text-right whitespace-pre-line">
      ...
      <section class="w-full flex flex-col items-center justify-center px-4 py-6 md:py-2 md:p-6 text-slate-800 dark:text-slate-100">
        <div class="md:text-center text-lg md:text-2xl max-w-3xl mx-auto py-2 px-6 md:px-0 md:pt-4 md:pb-12" v-html="heroTextWithLinks"></div>
    ...
    <section class="w-full bg-slate-900 bg-[url('@/assets/debut-dark.png')] py-24 mt-4 md:mt-28 relative">
      ...
      <div class="relative">
        <h2 class="text-4xl md:text-5xl my-4 font-title text-center text-white">
          ...
          <span class="text-xl md:text-2xl text-slate-100 block mt-3 uppercase font-bold font-mono">{{ $t('welcome.understanding.subtitle') }}</span>
        </h2>

        <!-- Mission Statement -->
        <div class="mb-24">
          <p class="text-center text-xl md:text-3xl max-w-4xl mx-auto my-16 text-slate-100 font-extralight leading-relaxed px-6 whitespace-pre-line">
        ...
        <!-- FAQ Section -->
        <div class="py-20">
          <h2 class="text-3xl md:text-4xl mb-16 font-mono uppercase text-center text-white">{{ $t('welcome.faq.title') }}</h2>
